          ...
          <div className="row">
              ...
              <div className="card">
                ...
                <div className="card-body card-block">
                  ...
                  <div className="row form-group">
                    <div className="col-8">
                      <div className="form-group">
                        <label for="city" className=" form-control-label">
                          City
                        </label>
                        <input
                          type="text"
                  ...
                  <div className="form-group">
                    <label for="country" className=" form-control-label">
                      Country
                    </label>
                    <input
                      type="text"
              ...
              <div className="card">
                ...
                <div className="card-body card-block">
                  ...
                  >
                    ...
                    <div className="row form-group">
                      <div className="col col-md-3">
                        <label for="selectLg" className=" form-control-label">
                          Select Large
                        </label>
                      </div>
                      <div className="col-12 col-md-9">
                    ...
                    <div className="row form-group">
                      <div className="col col-md-3">
                        <label for="selectSm" className=" form-control-label">
                          Select Small
                        </label>
                      </div>
                      <div className="col-12 col-md-9">
                    ...
                    <div className="row form-group">
                      <div className="col col-md-3">
                        <label for="file-input" className=" form-control-label">
                          File input
                        </label>
                      </div>
                      <div className="col-12 col-md-9">
                  ...
                  <form action="" method="post" className="form-inline">
                    ...
                    <div className="form-group">
                      <label
                        ...
                        className="px-1  form-control-label"
                      >
                        Email
                      </label>
                      <input
              ...
              <div className="card">
                ...
                <div className="card-body card-block">
                  <form action="" method="post" className="form-horizontal">
                    <div className="row form-group">
                      <div className="col col-md-3">
                        <label for="hf-email" className=" form-control-label">
                          Email
                        </label>
                      </div>
                      <div className="col-12 col-md-9">
              ...
              <div className="card">
                ...
                <div className="card-body card-block">
                  <form action="" method="post" className="">
                    <div className="form-group">
                      <label for="nf-email" className=" form-control-label">
                        Email
                      </label>
                      <input
                        type="email"
                    ...
                    <div className="form-group">
                      <label for="nf-password" className=" form-control-label">
                        Password
                      </label>
                      <input
                        type="password"
              ...
              <div className="card">
                ...
                <div className="card-body card-block">
                  <div className="has-success form-group">
                    <label for="inputIsValid" className=" form-control-label">
                      Input is valid
                    </label>
                    <input
                      type="text"
                      id="inputIsValid"
                      className="is-valid form-control-success form-control"
                    />
                  </div>
                  <div className="has-warning form-group">
                    <label for="inputIsInvalid" className=" form-control-label">
                      Input is invalid
                    </label>
                    <input
                      type="text"
            ...
            <div className="col-lg-6">
              <div className="card">
                ...
                <div className="card-body card-block">
                  <div className="has-success form-group">
                    <label for="inputSuccess2i" className=" form-control-label">
                      Input with success
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="has-warning form-group">
                    <label for="inputWarning2i" className=" form-control-label">
                      Input with warning
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="has-danger has-feedback form-group">
                    <label for="inputError2i" className=" form-control-label">
                      Input with error
                    </label>
                    <input
                      type="text"
